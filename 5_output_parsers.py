...
"""
This example demonstrates how to use output parsers in LangChain to structure the output of language models. 
We will cover three types of output parsers: 
StrOutputParser, JsonOutputParser, and PydanticOutputParser. Additionally, we will show how to use 
structured output with a custom Pydantic model.
"""
